    ...
    $scope.setCurrency = function(currency) {
      ...
      if (currency === 'USD') {
        Currency.get({}, function(res) {
          $rootScope.currency.factor = $rootScope.currency.usdRate = res.data.usdRate;
        });
      } else if (currency === 'BTC') {
        Currency.get({}, function(res) {
          $rootScope.currency.factor = $rootScope.currency.btcRate = res.data.btcRate;
        });        
      } else {
...
angular.module('insight.system').controller('ScannerController',
  function($scope, $rootScope, $modalInstance, Global) {
    ...
    qrcode.callback = function(data) {
      ...
      var str = (data.indexOf('digibyte:') === 0) ? data.substring(9) : data; 
